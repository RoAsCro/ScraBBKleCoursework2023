...
public class BoardLoadingTest {
    ...
    public void testTileLoading() {
        ...
        // Characters in wrong order: {2)
        assertNull(TestUtility.loadBoardFromTestBoards("wrongCharOrderBoard.txt"));
        ...
        assertNull(TestUtility.loadBoardFromTestBoards("dotInBrackets.txt"));
